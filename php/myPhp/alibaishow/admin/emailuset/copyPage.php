        ...
        <div class="col-md-8">
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <ul class="pagination pagination-sm pull-right">
                <li><a href="./copyPage.php?page=1">首页</a></li>

                    <li> <a href="./copyPage.php?page=<?= $num > $pageall -2 ? $pageall - 2 : $num?>"><?= $num > $pageall -2 ? $pageall - 2 : $num?></a></li>
                    <li> <a href="./copyPage.php?page=<?= $num+1 > $pageall - 1 ? $pageall - 1: $num+1?>"><?= $num+1 > $pageall - 1 ? $pageall - 1: $num+1?></a></li>
                    <li> <a href="./copyPage.php?page=<?= $num+2 > $pageall ? $pageall: $num+2?>"><?= $num+2 > $pageall ? $pageall: $num+2?></a></li>


                <li><a href="./copyPage.php?page=<?= $pageall?>">尾页</a></li>
