...
<?php include_once './../commin/session.php';?>
  <div class="main">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-4">
          <form action="./add-deal.php" method="post">
            <h2>添加新分类目录</h2>
